...
One toggle, zero dead air. Flip Party Mode on and the app auto-plays each song's peak section
...
I can skip and seek, but I can't blend. It's a ceiling I can't break from the outside.

### 6. Why JioSaavn (not me) should own this
- JioSaavn owns its own player, so it has full crossfade & gapless control.
- JioSaavn owns the Indian catalog and the party-culture audience.
- JioSaavn has no public API, so no third party can build this from the outside. Only
  JioSaavn can. The blocker that stops me on Spotify simply doesn't exist on your stack.
...
- **High-intent, high-spend moment:** people in party mode pay for anything that keeps the
  night going, and Party Mode is exactly that.
- **Viral:** one party exposes a whole room of friends at once, driving word-of-mouth.
...
> skips the dead air. Tested it at college parties and it works. Spotify can't do crossfade;
> you can. Happy to share screen recordings. rishinikamai@gmail.com

**One-line elevator pitch:**
> I built a "Party Mode" prototype that auto-plays each song's peak and skips to the next
> song's peak, and tested it at real parties. JioSaavn owns its player, so you could add
> crossfade and ship this as a premium feature.
